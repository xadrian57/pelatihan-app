<div id="sidebar">
    ...
    <div class="logo">
        <a href="index.html"><img src="{{ url('/') }}/assets/compiled/svg/logo.svg" alt="Logo" srcset=""></a>
    </div>
...
<ul class="menu">
    ...
    <li class="sidebar-item  ">
        <form action="{{ route('logout') }}" method="post">
            @csrf
            <button type="submit" class="btn icon icon-left btn-danger"><i class="bi bi-power"></i>Logout</a></button>
        </form>
    </li>
</ul>
</div>
