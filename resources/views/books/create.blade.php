                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 my-2">
                            ...
                            <input type="text" class="form-control @error('author') is-invalid @enderror" id="author"
                                placeholder="Author" value="{{ old('author') }}" name="author" required>
                            @error('author') 
                            <div class="invalid-feedback">
                                <i class="bx bx-radio-circle"></i>
                                {{ $message }}
                        ...
                        <div class="col-sm-6 my-2">
                            ...
                            <input type="text" class="form-control @error('publisher') is-invalid @enderror" id="publisher" name="publisher"
                                placeholder="publisher" value="{{ old('publisher') }}" name="publisher" required>
                            @error('publisher') 
                            <div class="invalid-feedback">
                                <i class="bx bx-radio-circle"></i>
                                {{ $message }}
                        ...
                        <div class="col-sm-6 my-2">
                            ...
                            <input type="text" class="form-control @error('year') is-invalid @enderror" id="year"
                                placeholder="Year" value="{{ old('year') }}" name="year" required>
                            @error('year') 
                            <div class="invalid-feedback">
                                <i class="bx bx-radio-circle"></i>
                                {{ $message }}
